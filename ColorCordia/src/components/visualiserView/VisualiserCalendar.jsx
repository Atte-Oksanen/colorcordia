...
const VisualiserCalendar = ({ colors }) => {
  ...
  return (
    <div className="bg-gray-200 p-4 overflow-auto h-[66vh] rounded-lg">
      <h2 className="text-xl font-normal">MyCalendar</h2>
      <h3 className="text-base font-normal text-gray-600">Monday</h3>
      ...
      <div className="rounded-md p-2 border border-black"
        style={{ color: getTextColor(colors[4]), background: colors[4], }}>
        14.00 | Unveiling new marketing concepts
      </div>
      <div className="rounded-md p-2 border border-black"
        style={{ color: getTextColor(colors[2]), background: colors[2], }}>
      ...
      <h3 className="text-base font-normal text-gray-600">Tuesday</h3>
      <div className="rounded-md p-2 border border-black bg-white"
        style={{ color: getTextColor(colors[4]), background: colors[4] }}>
        8.00 | Standup
      </div>
      ...
      <h3 className="text-base font-normal text-gray-600">Wednesday</h3>
      <div className="rounded-md p-2 border border-black"
        style={{ color: getTextColor(colors[4]), background: colors[4] }}>
        8.00 | Standup
      </div>
