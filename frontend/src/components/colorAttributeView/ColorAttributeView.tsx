...
const ColorAttributeView = () => {
  ...
  return (
    <div className="p-4 h-screen">
      ...
      <div className="w-3/4 h-[80vh] m-auto element-border rounded-lg">
        <div className="grid grid-cols-1 h-full grid-rows-[1fr_1fr_4rem]">
          <div className="grid grid-rows-[2rem_1fr] mt-4">
            <h3 className="block text-xl font-normal ml-4">{color}</h3>
            <div style={{ background: color }}></div>
          </div>
          <div className="grid grid-cols-2 h-full overflow-hidden grid-rows-[1fr_6fr]">
            ...
            <div className="overflow-y-scroll m-4 p-2 element-border rounded-l-lg">
          ...
          <div className="flex justify-end">
            <div className="mx-4">
              <button className="pill-button-empty mr-2 text-lg" onClick={skipColor}>Skip color</button>
              <button className="pill-button text-lg disabled:bg-blue-400" disabled={pickedAttributes.length === 0} onClick={submitAttributes}>Submit Attributes</button>
            </div>
          </div>
        </div>
      </div>
